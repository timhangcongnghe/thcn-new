...
/*global thcn_admin_meta_boxes, thcn_admin, accounting */
;(function($) {
    /**
     * Order Items Panel
     */
    var dokan_seller_meta_boxes_order_items = {
        init: function() {
            ...
            $( '#thcn-order-items' )
                ...
                // Subtotal/total
                .on( 'keyup', '.thcn_order_items .split-input input:eq(0)', function() {
                ...
                .on( 'keyup', '.thcn_order_items .split-input input:eq(1)', function() {
        ...
        reload_items: function() {
            ...
            $.ajax({
                ...
                success: function( response ) {
                    $( '.dokan-panel-default #thcn-order-items' ).empty();
                    $( '.dokan-panel-default #thcn-order-items' ).append( response );
        ...
        refund_items: function() {
            ...
            $( '#thcn-order-items div.refund' ).show();
        ...
        cancel: function() {
            ...
            $( '#thcn-order-items div.refund' ).hide();
        ...
        refunds: {
            ...
            input_changed: function() {
                var refund_amount = 0;
                var $items        = $( '.thcn_order_items' ).find( 'tr.item, tr.fee, tr.shipping' );
            ...
            refund_quantity_changed: function() {
                ...
                if ( refund_qty > 0 ) {
                    ...
                    $( '.thcn_order_items input.refund_order_item_qty' ).each( function() {
                        if ( $( this ).val() > 0 ) {
                            $( '#restock_refunded_items' ).closest( 'tr' ).show();
                        }
                    });
...
(function($) {
  ...
  $(document.body)
    ...
    .on('init_tooltips', function() {
      $('.tips, .help_tip, .thcn-help-tip').tipTip({
        attribute: 'data-tip',
        fadeIn: 50,
        fadeOut: 50,
        delay: 200
