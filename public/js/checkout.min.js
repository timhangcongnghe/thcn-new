jQuery(function (g) {
	...
	var f = {
			...
			payment_method_selected: function (e) {
				...
				var t = g('.thcn-checkout input[name="payment_method"]:checked').attr("id");
			...
			validate_field: function (e) {
				var t = g(this),
					...
					a = "",
					e = e.type;
				"input" === e && o.removeClass("thcn-invalid thcn-invalid-required-field thcn-invalid-email thcn-invalid-phone thcn-validated"), "validate" !== e && "change" !== e || (i && ("checkbox" === t.attr("type") && !t.is(":checked") || "" === t.val()) && (o.removeClass("thcn-validated").addClass("thcn-invalid thcn-invalid-required-field"), c = !1), n && t.val() && ((a = new RegExp(/^([a-z\d!#$%&'*+\-\/=?^_`{|}~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+(\.[a-z\d!#$%&'*+\-\/=?^_`{|}~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+)*|"((([ \t]*\r\n)?[ \t]+)?([\x01-\x08\x0b\x0c\x0e-\x1f\x7f\x21\x23-\x5b\x5d-\x7e\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|\\[\x01-\x09\x0b\x0c\x0d-\x7f\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))*(([ \t]*\r\n)?[ \t]+)?")@(([a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|[a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF][a-z\d\-._~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]*[a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])\.)+([a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|[a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF][a-z\d\-._~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]*[0-9a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])\.?$/i)).test(t.val()) || (o.removeClass("thcn-validated").addClass("thcn-invalid thcn-invalid-email thcn-invalid-phone"), c = !1)), r && (a = new RegExp(/[\s\#0-9_\-\+\/\(\)\.]/g), 0 < t.val().replace(a, "").length && (o.removeClass("thcn-validated").addClass("thcn-invalid thcn-invalid-phone"), c = !1)), c && o.removeClass("thcn-invalid thcn-invalid-required-field thcn-invalid-email thcn-invalid-phone").addClass("thcn-validated"))
			},
			...
			// 	}), h.shipping_method = _), g(".thcn-checkout-payment, .thcn-checkout-review-order-table").block({
			// 		message: null,
			// 		overlayCSS: {
			// 			background: "#fff",
			// 			opacity: .6
			...
			// 		success: function (e) {
			// 			var t, o;
			// 			e && !0 === e.reload ? window.location.reload() : (g(".thcn-NoticeGroup-updateOrderReview").remove(), o = g("#terms").prop("checked"), t = {}, g(".payment_box :input").each(function () {
			...
			// 			}), e && "failure" === e.result && (o = g("form.checkout"), g(".thcn-error, .thcn-message").remove(), e.messages ? o.prepend('<div class="thcn-NoticeGroup thcn-NoticeGroup-updateOrderReview">' + e.messages + "</div>") : o.prepend(e), o.find(".input-text, select, input:checkbox").trigger("validate").trigger("blur"), f.scroll_to_notices()), f.init_payment_methods(), g(document.body).trigger("updated_checkout", [e]))
			// 		}
			// 	}))
			// },
				...
				return o.is(".processing") || !1 !== o.triggerHandler("checkout_place_order") && !1 !== o.triggerHandler("checkout_place_order_" + f.get_payment_method()) && (o.addClass("processing"), f.blockOnSubmit(o), f.attachUnloadEventsOnSubmit(), g.ajaxSetup({
					...
					success: function (e) {
						...
						try {
							...
							!0 === e.refresh && g(document.body).trigger("update_checkout"), e.messages ? f.submit_error(e.messages) : f.submit_error('<div class="thcn-error">' + wc_checkout_params.i18n_checkout_error + "</div>")
						}
					},
					error: function (e, t, o) {
						f.detachUnloadEventsOnSubmit(), f.submit_error('<div class="thcn-error">' + o + "</div>")
					}
				})), !1
			},
			submit_error: function (e) {
				g(".thcn-NoticeGroup-checkout, .thcn-error, .thcn-message").remove(), f.$checkout_form.prepend('<div class="thcn-NoticeGroup thcn-NoticeGroup-checkout">' + e + "</div>"), f.$checkout_form.removeClass("processing").unblock(), f.$checkout_form.find(".input-text, select, input:checkbox").trigger("validate").trigger("blur"), f.scroll_to_notices(), g(document.body).trigger("checkout_error", [e])
			},
			scroll_to_notices: function () {
				var e = g(".thcn-NoticeGroup-updateOrderReview, .thcn-NoticeGroup-checkout");
				e.length || (e = g(".form.checkout")), g.scroll_to_notices(e)
			}
		},
		e = {
			init: function () {
				g(document.body).on("click", "a.showcoupon", this.show_coupon_form), g(document.body).on("click", ".thcn-remove-coupon", this.remove_coupon), g("form.checkout_coupon").hide().on("submit", this.submit)
			},
			...
			submit: function () {
				...
				return g.ajax({
					...
					data: o,
					success: function (e) {
						g(".thcn-error, .thcn-message").remove(), t.removeClass("processing").unblock(), e && (t.before(e), t.slideUp(), g(document.body).trigger("applied_coupon_in_checkout", [o.coupon_code]), g(document.body).trigger("update_checkout", {
			...
			remove_coupon: function (e) {
				e.preventDefault();
				var t = g(this).parents(".thcn-checkout-review-order"),
				...
				g.ajax({
					...
					data: o,
					success: function (e) {
						g(".thcn-error, .thcn-message").remove(), t.removeClass("processing").unblock(), e && (g("form.thcn-checkout").before(e), g(document.body).trigger("removed_coupon_in_checkout", [o.coupon_code]), g(document.body).trigger("update_checkout", {
							update_shipping_method: !1
		...
		t = {
			...
			show_login_form: function () {
				return g("form.login, form.thcn-form--login").slideToggle(), !1
			}
		},
		o = {
			init: function () {
				g(document.body).on("click", "a.thcn-terms-and-conditions-link", this.toggle_terms)
			},
			toggle_terms: function () {
				if (g(".thcn-terms-and-conditions").length) return g(".thcn-terms-and-conditions").slideToggle(function () {
					var e = g(".thcn-terms-and-conditions-link");
					g(".thcn-terms-and-conditions").is(":visible") ? (e.addClass("thcn-terms-and-conditions-link--open"), e.removeClass("thcn-terms-and-conditions-link--closed")) : (e.removeClass("thcn-terms-and-conditions-link--open"), e.addClass("thcn-terms-and-conditions-link--closed"))
				}), !1
			}
		};
